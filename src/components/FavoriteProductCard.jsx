...
const FavoriteProductCard = ({ product, favoriteId, handleProductClick, handleKeyDown, handleRemove }) => {
  ...
  return (
    <article
      className="flex flex-col h-[20em] w-[13em] border-2 border-gray-300 rounded-xl overflow-hidden hover:shadow-sm focus:shadow-sm focus:outline-none transition-shadow duration-200 relative"
      role="gridcell"

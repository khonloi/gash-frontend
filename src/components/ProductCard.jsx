...
const ProductCard = ({ product, handleProductClick, handleKeyDown }) => {
  ...
  return (
    <article
      className="flex flex-col h-[22em] w-[14em] border-2 border-gray-300 rounded-xl overflow-hidden hover:shadow-md focus:shadow-md focus:outline-none cursor-pointer transition-shadow duration-200"

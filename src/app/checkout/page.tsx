    ...
    <div className={styles.checkoutPage}>
      <div className="container">
        ...
        <div style={{ fontSize: '0.875rem', color: 'var(--color-text-muted)', display: 'flex', gap: '8px', alignItems: 'center' }}>
          ...
          <span style={{ fontWeight: 500, color: 'var(--color-text)' }}>Information</span>
          <ChevronRight size={14} />
          <span>Shipping</span>
          <ChevronRight size={14} />
          <span>Payment</span>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.inputGroup}>
            <input type="email" placeholder="Email or mobile phone number" className={styles.input} />
            <label style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '0.875rem', marginTop: '8px', color: 'var(--color-text-muted)' }}>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.formGrid}>
            <div className={styles.inputGroup} style={{ gridColumn: '1 / -1' }}>
              <input type="text" placeholder="Country/Region" defaultValue="Vietnam" className={styles.input} />
            </div>
            <div className={styles.inputGroup}>
        ...
        <section className={styles.section}>
          ...
          <p style={{ fontSize: '0.875rem', color: 'var(--color-text-muted)', marginBottom: '8px' }}>All transactions are secure and encrypted.</p>
          <div className={styles.radioGroup}>
            <label className={styles.radioOption}>
              <input 
                type="radio" 
              ...
              <div className={styles.radioLabel}>
                ...
                <span className={styles.radioDesc}>Pay with cash upon delivery.</span>
              </div>
            </label>
            <label className={styles.radioOption}>
              <input 
              ...
              <div className={styles.radioLabel}>
                ...
                <span className={styles.radioDesc}>Visa, Mastercard, AMEX, JCB</span>
              </div>
            </label>
            <label className={styles.radioOption}>
              <input 
            ...
            <label className={styles.radioOption}>
              ...
              <div className={styles.radioLabel}>
                ...
                <span className={styles.radioDesc}>Scan QR code with banking app</span>
              </div>
            </label>
          </div>
        </section>
      ...
      <div className={styles.rightColumn}>
        ...
        <div className={styles.totals}>
          <div className={styles.totalRow}>
            <span>Subtotal</span>
            <span style={{ color: 'var(--color-text)', fontWeight: 500 }}>{formatPrice(subtotal)}</span>
          </div>
          <div className={styles.totalRow}>
            <span>Shipping</span>

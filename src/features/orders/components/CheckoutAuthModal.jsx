...
/**
 * Authentication confirmation modal during checkout for high-security orders.
 */
export default function CheckoutAuthModal({ open, onClose, onAuthenticated, user, passkeys = [] }) {
        ...
        <div className="space-y-6">
          ...
          {hasPassword && (
            <div className="space-y-3">
              ...
              >
                {isAuthenticating && authMethod === 'password'
                  ? 'Verifying...'
          ...
          {hasPasskeys && (
            <Button
              ...
              className="w-full justify-center py-3"
            >
              {isAuthenticating && authMethod === 'passkey'
                ? 'Authenticating...'

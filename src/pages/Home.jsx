...
const carouselSlides = [
  {
    subtitle: "Summer streetwear refresh",
    title: "New & trending",
  ...
  {
    subtitle: "Exclusive member offer",
    title: "Special discounts",
    description: "Enjoy exclusive deals, member-only vouchers, and personalized style recommendations.",
    buttonText: "Claim vouchers",
    link: "/vouchers",
    bgClass: "bg-[#fef9c3]",
  ...
  },
  {
    ...
    description: "Find high-quality shoes, designer shirts, hoodies, and jackets built for durability.",
  ...
  {
    subtitle: "Speed & convenience",
    title: "Express shipping",
    description: "Get fast, reliable delivery and seamless returns/exchanges on all catalog items.",
  ...
  {
    subtitle: "GASH community",
    title: "Join the GASH club",
    description: "Save your favorites, get early access to drops, and track your orders in real-time.",
...
const Home = () => {
  ...
  const textClass = `z-10 w-full md:w-3/5 pl-6 pr-6 py-8 sm:pl-10 md:pl-12 lg:pl-16 text-left flex flex-col items-start justify-center animate-[fadeIn_0.3s_ease-out] ${
    slide.alignRight ? "md:ml-auto" : ""
  }`;
  const imgContainerClass = `absolute bottom-0 top-0 w-1/2 h-full hidden md:block select-none pointer-events-none z-0 ${
    slide.alignRight ? "left-0" : "right-0"
  }`;
  const parentClass = `relative w-full rounded-xl border-2 border-gray-300 overflow-hidden flex items-center min-h-[350px] md:min-h-[450px] lg:min-h-[500px] transition-colors duration-500 ${
    slide.bgClass
  }`;
      ...
      <div className="w-full mb-6 sm:mb-8">
        <div className={parentClass}>
          ...
          <div className={textClass}>
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#0f2942] leading-tight mb-2 sm:mb-3">
              {slide.title}
            </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-5 bg-[#c3daf9] border-2 border-gray-300 rounded-xl p-6 sm:p-8 flex flex-col justify-between overflow-hidden relative min-h-[350px] transition-all duration-300 ease-in-out hover:shadow-lg">
                <div className="z-10 flex flex-col items-start text-left max-w-xs">
                  <span className="text-xs font-semibold text-blue-950 uppercase tracking-widest">
                    GASH Gift Cards
                  </span>
                  <h3 className="text-2xl sm:text-3xl font-extrabold text-[#0d2847] mt-2 mb-6 leading-tight">
                    Red, white & blue style cards
                  </h3>
                  <Button
                ...
                <div className="absolute -right-6 -bottom-6 w-52 h-44 pointer-events-none select-none">
                  ...
                  <div className="absolute right-12 bottom-12 w-40 h-24 bg-gradient-to-br from-[#111827] to-[#1f2937] text-white rounded-xl p-3 shadow-lg border border-gray-800 flex flex-col justify-between rotate-[-12deg] z-10 transition-transform duration-300 hover:rotate-0">
                    <div className="flex justify-between items-start">
                      <span className="text-[10px] font-bold text-amber-500 tracking-wider">GASH</span>
                  ...
                  <div className="absolute right-4 bottom-4 w-40 h-24 bg-white text-gray-900 rounded-xl p-3 shadow-md border border-gray-200 flex flex-col justify-between rotate-[4deg]">
                    <div className="flex justify-between items-start">
                      <span className="text-[10px] font-bold text-blue-900 tracking-wider">GASH</span>
              ...
              <div className="lg:col-span-4 flex flex-col gap-6">
                ...
                <div className="bg-[#f2f4f7] border-2 border-gray-300 rounded-xl p-6 flex justify-between items-center overflow-hidden min-h-[160px] transition-all duration-300 ease-in-out hover:shadow-lg">
                  <div className="flex flex-col items-start text-left max-w-[60%]">
                    ...
                    <h4 className="text-lg font-bold text-[#0d2847] mt-1 mb-2">
                ...
                <div className="grid grid-cols-2 gap-4 flex-1">
                  ...
                  <div className="bg-[#eaeff5] border-2 border-gray-300 rounded-xl p-5 flex flex-col justify-between overflow-hidden min-h-[160px] transition-all duration-300 ease-in-out hover:shadow-lg">
                    <div className="flex flex-col items-start text-left">
                      <h4 className="text-sm sm:text-base font-extrabold text-[#0d2847] leading-snug">
                        Join the GASH club today
                      </h4>
                      <button
                        onClick={() => navigate("/signup")}
                        className="text-xs font-bold text-blue-700 underline hover:text-blue-900 mt-2"
                      >
                        Register
                      </button>
                    </div>
              ...
              <div className="lg:col-span-3 bg-white border-2 border-gray-300 rounded-xl p-6 sm:p-8 flex flex-col justify-between overflow-hidden relative min-h-[350px] transition-all duration-300 ease-in-out hover:shadow-lg">
                <div className="z-10 flex flex-col items-start text-left">
                  ...
                  <h3 className="text-xl font-bold text-[#0d2847] mt-2 mb-2">
                    5% cash back rewards on all items
                  </h3>
                  <button
                ...
                <div className="relative mt-8 mb-4">
                  ...
                  <div className="relative w-44 h-28 bg-gradient-to-br from-[#0c1a30] to-[#1a385c] rounded-2xl border border-blue-900/30 p-4 flex flex-col justify-between shadow-xl mx-auto transition-all duration-300 hover:rotate-1 hover:scale-105">
                    <div className="flex justify-between items-start">
                      <span className="text-[10px] font-black text-amber-400 tracking-wider">GASH</span>
                    ...
                    <div>
                      ...
                      <div className="text-[8px] text-gray-400 uppercase mt-0.5 font-bold">Gold Member</div>
                    </div>
                  </div>
                </div>

                <span className="text-[10px] font-bold text-gray-400 tracking-wider text-center block uppercase mt-2">
